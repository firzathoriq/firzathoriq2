...
model=pkl.load(open("penyakit_jantung.sav","rb"))





st.set_page_config(page_title="Jantung app",page_icon="⚕️",layout="centered",initial_sidebar_state="expanded")
...
html_temp = """ 
    ...
    <h1 style ="color:black;text-align:center;">Jantung app</h1> 
    </div> 
    """
